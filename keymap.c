...
[_QWERTY] = LAYOUT(
  ...
  CAPSWORD,  KC_Z,  KC_X,    CUSTOM_C,  CUSTOM_V,  KC_B, KC_MUTE,     XXX, KC_N,    KC_M,    KC_COMM, KC_DOT, CAPSWORD, KC_MINS,
    MO(_TMUX), KC_LALT, ___, LEFT_THUMB, OSL(_SYMBOL),       OSL(_SYMBOL),  RIGHT_THUMB, ___, KC_RALT, KC_RGUI
),
...
___,   ___, KC_LABK,  KC_MINS,  KC_EQL,  KC_RABK,           KC_LPRN,  KC_COLN,   KC_HASH,  KC_RPRN,   KC_PIPE,   KC_DQUO,
